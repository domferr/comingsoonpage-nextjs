...
function Hearth() {
  const size = 14;
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 512 512">
      <path fill="#FF6647" d="M474.655,74.503C449.169,45.72,413.943,29.87,375.467,29.87c-30.225,0-58.5,12.299-81.767,35.566
    ...
    <div className="page-container">
      <div className="content">
        <div className="logo-container">
          <FadeInImage src="/soonlogo.png" width={500} height={500} layout="responsive" className="logo" priority/>
        </div>
        <h1 className="under-constr-title">This website is under construction</h1>
        <div className="under-constr-subtitle">We are coming soon!</div>
      </div>
      <footer>
        Made with <Hearth /> by <a href="https://ferrarodomenico.com" target="_blank" rel="noreferrer">Domenico Ferraro</a>
      </footer>
    </div>
  )
}
